...
class DashboardController {
    ...
    public function sendWishlistVoucher()
    {
        ...
        if (empty($email) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            header("Location: " . BASE_URL . "index.php?page=wishlist_report");
            exit;
        }
        ...
        try {
            ...
            $mailBody = '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #fff; border: 1px solid #e5e7eb; border-radius: 16px;">'
                ...
                . '<a href="' . BASE_URL . 'index.php?page=allproducts" style="display:inline-block;padding:13px 28px;background:#c19a4e;color:#111827;text-decoration:none;border-radius:999px;font-weight:700;">Browse products</a>'
                . '</div>'
    ...
    public function sendRetentionEmail() {
        ...
        try {
            ...
            $mail->Body = "
                <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #ffffff; color: #111827;'>
                    ...
                    <div style='text-align: center; margin: 30px 0;'>
                        <a href='" . BASE_URL . "index.php?page=checkout' style='display: inline-block; padding: 12px 30px; background: linear-gradient(135deg, #c19a4e 0%, #8b5a2b 100%); color: #ffffff; text-decoration: none; font-weight: 700; border-radius: 50px; text-transform: uppercase; box-shadow: 0 4px 15px rgba(193, 154, 78, 0.3); font-size: 14px;'>Redeem at Checkout</a>
                    </div>
            ...
            $mail->AltBody = "Hello {$name}, we miss you at Stitch Smart! Use voucher {$voucherCode} for {$discountPercent}% off on your next order at " . BASE_URL . "index.php?page=checkout";
