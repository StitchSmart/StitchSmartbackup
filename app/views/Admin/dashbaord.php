        ...
        <div class="col-md-4">
            <div class="box dbox b text-center p-4 rounded shadow-sm">
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <h3 class="fw-bold mb-0"><?php echo $counts['categories'] ?? 0 ?> <span class="fs-6 text-light fw-normal opacity-75">Main</span></h3>
                    <span class="fs-5 text-light opacity-50">|</span>
                    <h3 class="fw-bold mb-0"><?php echo $counts['subcategories'] ?? 0 ?> <span class="fs-6 text-light fw-normal opacity-75">Sub</span></h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        ordersChartInstance = new Chart(ordersCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: 'rgba(193, 154, 78, 0.85)',
                    borderColor: '#c19a4e',
                    borderWidth: 1,
                    borderRadius: 6,
