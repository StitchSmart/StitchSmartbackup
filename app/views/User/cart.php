...
<link href="<?= BASE_URL ?>css/navbar.css" rel="stylesheet">
  ...
  <style>
    ...
    .orb-1 {
      width: 180px;
      height: 180px;
      background: rgba(193, 154, 78, 0.28);
      top: 10%;
      left: 15%;
    }
    ...
    .empty-cart-container::before {
      ...
      right: 15px;
      bottom: 15px;
      border: 1px dashed rgba(193, 154, 78, 0.25);
      border-radius: 20px;
      pointer-events: none;
    ...
    .empty-cart-container:hover {
      ...
      box-shadow: 0 40px 80px rgba(193, 154, 78, 0.12), 0 30px 65px rgba(0, 0, 0, 0.4);
    }
    ...
    .empty-cart-container:hover::before {
      border-color: rgba(193, 154, 78, 0.45);
    }
    ...
    @keyframes pulseGlow {
      0% { box-shadow: 0 0 0 0 rgba(193, 154, 78, 0.45); }
      70% { box-shadow: 0 0 0 16px rgba(193, 154, 78, 0); }
      100% { box-shadow: 0 0 0 0 rgba(193, 154, 78, 0); }
    }
    ...
    .icon-circle {
      ...
      height: 105px;
      border-radius: 50%;
      background: linear-gradient(135deg, rgba(193, 154, 78, 0.15) 0%, rgba(193, 154, 78, 0.25) 100%);
    ...
    .btn-shop-now {
      ...
      box-shadow: 0 8px 20px rgba(193, 154, 78, 0.25), 0 10px 20px rgba(0, 0, 0, 0.2);
    ...
    :root.theme-default .btn-shop-now {
      background: linear-gradient(135deg, #c89a5a 0%, #a88048 100%);
    ...
    .btn-shop-now:hover {
      ...
      box-shadow: 0 12px 25px rgba(193, 154, 78, 0.45), 0 15px 30px rgba(0, 0, 0, 0.25);
      color: #1a0f0a !important;
      text-decoration: none;
    }
...
<div class="container py-5" >
    ...
    <?php if(empty($_SESSION['cart'])): ?>
        <div class="empty-cart-wrapper">
            ...
            <div class="empty-cart-container text-center py-5">
                ...
                <a href="<?= BASE_URL; ?>/index.php?page=allproducts" class="btn btn-shop-now">
    ...
    <?php else: ?>
        ...
        <div class="cart-actions mt-4">
            <a href="<?= BASE_URL; ?>/index.php?page=allproducts" class="btn btn-secondary">
                Continue Shopping
            </a>
