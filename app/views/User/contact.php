...
.contact-hero::before {
    ...
    inset: 0;
    background:
        radial-gradient(ellipse 60% 70% at 80% 50%, rgba(202, 151, 69,0.13) 0%, transparent 60%),
        radial-gradient(ellipse 40% 50% at 10% 80%, rgba(202, 151, 69,0.07) 0%, transparent 55%);
}
.hero-orb {
    position: absolute;
    border-radius: 50%;
    background: radial-gradient(circle, rgba(202, 151, 69,0.18), transparent 70%);
...
.hero-title span { color: #ca9745 !important; }
.hero-subtitle {
...
.info-card:hover {
    ...
    box-shadow: 0 16px 40px rgba(202, 151, 69,0.12);
...
.info-icon {
    ...
    height: 52px;
    border-radius: 14px;
    background: linear-gradient(135deg, rgba(202, 151, 69,0.15), rgba(202, 151, 69,0.05));
...
.info-card:hover .info-icon {
    background: linear-gradient(135deg, rgba(202, 151, 69,0.25), rgba(202, 151, 69,0.10));
...
.info-value a:hover { color: #ca9745; }
...
.form-card::before {
    ...
    height: 4px;
    background: linear-gradient(90deg, #ca9745, #e8c97a, #ca9745);
    background-size: 200%;
...
.form-floating .form-select {
    border: 1.5px solid rgba(202, 151, 69,0.2);
    border-radius: 12px;
    background: #fdfaf6;
    color: #1a0f0a;
    font-size: 0.95rem;
...
.form-floating .form-select:focus {
    border-color: #ca9745;
    background: #fff;
    box-shadow: 0 0 0 3px rgba(202, 151, 69,0.12);
    outline: none;
}
...
.subject-pill {
    padding: 7px 16px;
    border-radius: 50px;
    border: 1.5px solid rgba(202, 151, 69,0.3);
...
.btn-contact-submit:hover {
    transform: translateY(-2px);
    box-shadow: 0 14px 36px rgba(202, 151, 69,0.35);
}
...
.map-header-icon {
    ...
    height: 42px;
    border-radius: 10px;
    background: rgba(202, 151, 69,0.2);
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                <div class="form-card">
                    ...
                    <form id="contactForm" method="POST" action="<?= url('') ?>contact_send" novalidate>
