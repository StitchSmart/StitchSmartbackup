...
:root.theme-luxury .co-page {
    ...
    --co-accent-soft:   rgba(193,154,78,0.18);
    ...
    .order-detail-page::before {
        ...
        position: absolute;
        inset: 0;
        background: radial-gradient(circle at center, rgba(193,154,78,0.05), transparent 40%);
        pointer-events: none;
    }
    .order-detail-hero {
        position: relative;
    ...
    .detail-block {
        ...
        border-radius: 20px;
        background: rgba(193,154,78,0.03) !important;
        border: 1px solid var(--co-border) !important;
        overflow: hidden;
    ...
    .detail-block:hover {
        ...
        border-color: var(--co-accent) !important;
        background: rgba(193,154,78,0.06) !important;
    }
    .detail-label {
        color: var(--co-text-muted) !important;
        font-size: 0.68rem;
    ...
    .order-items-card table tbody tr {
        background: rgba(193,154,78,0.02) !important;
    ...
    .btn-back-orders {
        ...
        box-shadow: 0 4px 14px rgba(193,154,78,0.25);
    }
    .btn-back-orders:hover {
        transform: translateY(-3px);
        box-shadow: 0 8px 25px rgba(193,154,78,0.4) !important;
    }
        ...
        <div class="order-detail-hero">
            <div class="row hero-top-row gy-3">
                ...
                <div class="col-lg-4 text-center text-lg-end">
                    <a href="<?= BASE_URL ?>/index.php?page=customer_orders" class="btn btn-back-orders">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (strtolower(trim($order['status'])) === 'delivered'): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="<?= BASE_URL ?>index.php?page=customer_return_request&order_id=<?= $order['id']; ?>&item_id=<?= $item['id']; ?>" 
