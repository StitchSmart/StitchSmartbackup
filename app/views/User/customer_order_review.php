...
:root.theme-luxury .rv-page {
    ...
    --rv-card-bg:       #111111;
    --rv-card-bg2:      #161616;
    --rv-border:        rgba(193,154,78,0.16);
    --rv-text-h:        #F4E9D3;
    --rv-text-body:     rgba(244,233,211,0.82);
    --rv-text-muted:    rgba(244,233,211,0.44);
    --rv-accent:        #C19A4E;
    --rv-accent-dk:     #8A6421;
    --rv-accent-grad:   linear-gradient(135deg,#C19A4E 0%,#8A6421 100%);
    --rv-accent-soft:   rgba(193,154,78,0.13);
    --rv-accent-glow:   rgba(193,154,78,0.28);
    ...
    --rv-input-border:  rgba(193,154,78,0.20);
...
.rv-page .rv-card:hover {
    ...
    border-color: rgba(193,154,78,0.35) !important;
}
    ...
    <div class="rv-header">
        <div class="container">
            <div class="rv-header-inner">
                ...
                <a href="<?= BASE_URL ?>/index.php?page=customer_orders" class="rv-back-btn">
                ...
                <div class="rv-card" style="animation-delay: <?= $delay ?>s !important;">
                    ...
                    <?php else: ?>
                        ...
                        <div class="rv-form-body">
                            <form method="POST" action="<?= BASE_URL ?>index.php?page=save_review" id="form_<?= $uid ?>">
