...
.co-page {
    ...
    --co-accent:        #CD9A48;
    --co-accent-dark:   #A07830;
    --co-accent-grad:   linear-gradient(135deg,#CD9A48,#A07830);
...
:root.theme-luxury .co-page {
    --co-bg:            #050505;
    --co-header-bg:     #0A0A0A;
    --co-border:        rgba(193,154,78,0.18);
    --co-card-bg:       #111111;
    --co-text-h:        #F4E9D3;
    ...
    --co-accent-grad:   linear-gradient(135deg,#C19A4E,#8A6421);
    --co-accent-soft:   rgba(193,154,78,0.14);
    --co-accent-softer: rgba(193,154,78,0.06);
...
.co-page .co-btn-primary {
    ...
    color: #fff !important;
    box-shadow: 0 4px 16px rgba(193,154,78,0.30) !important;
}
.co-page .co-btn-primary:hover { box-shadow: 0 8px 24px rgba(193,154,78,0.48) !important; }
...
.co-page .co-count-badge {
    ...
    color: var(--co-accent) !important;
    background: var(--co-accent-soft) !important;
    border: 1px solid rgba(193,154,78,0.25) !important;
...
.co-page .co-order-card:hover {
    ...
    border-color: rgba(193,154,78,0.45) !important;
}
...
.co-page .co-order-card:hover .co-thumb {
    border-color: rgba(193,154,78,0.40) !important;
    box-shadow: 0 6px 20px rgba(193,154,78,0.20) !important;
}
...
.co-page .co-tracking {
    background: var(--co-accent-softer) !important;
    border: 1px solid rgba(193,154,78,0.18) !important;
...
<div class="co-page-header">
    <div class="container">
        <div class="co-breadcrumb">
            <a href="<?= BASE_URL ?>/index.php?page=home"><i class="bi bi-house-fill"></i> Home</a>
        ...
        <div class="co-header-row">
            ...
            <a href="<?= BASE_URL ?>/index.php?page=allproducts" class="co-btn co-btn-primary">
...
<?php if (empty($orders)): ?>
    ...
    <div class="co-empty co-anim">
        ...
        <a href="<?= BASE_URL ?>/index.php?page=home" class="co-btn co-btn-primary">
            ...
            <article class="co-order-card w-100">
                ...
                <div class="co-card-footer">
                    <?php if (strtolower(trim($order['status'] ?? '')) === 'delivered'): ?>
                        <a href="<?= BASE_URL ?>/index.php?page=customer_order_review&id=<?= htmlspecialchars($order['id']) ?>"
                           class="co-btn co-btn-primary">
                            <i class="bi bi-star-fill"></i> Rate &amp; Review
                        </a>
                    <?php endif; ?>
                    <a href="<?= BASE_URL ?>/index.php?page=customer_order_detail&id=<?= htmlspecialchars($order['id']) ?>"
