...
<head>
    ...
    <style>
        ...
        .color-circle.selected { border: 2px solid var(--accent-bronze, #CD9A48); }
        ...
        function validateStep(step) {
            ...
            if (step === 1) {
                ...
                if (sampleVal === 'No') {
                    ...
                    let total = 0;
                    qs.forEach(id => { total += parseInt(document.getElementById(id).value || 0); });
                    if (total === 0) {
                        showValidationMessage('Please enter at least one quantity for your bulk order, or select "Yes" for a sample.');
                        return false;
                    }
                }
            }
