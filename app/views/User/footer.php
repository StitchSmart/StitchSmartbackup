...
<style>
  ...
  footer.footer {
    ...
    :root.theme-luxury footer.footer {
      background: radial-gradient(circle at top right, rgba(193, 154, 78, 0.08), transparent 38%),
  ...
  footer.footer::before { content: ''; position: absolute; top: -40px; right: -40px; width: 220px; height: 220px; background: rgba(193, 154, 78, 0.08); border-radius: 50%; filter: blur(32px); pointer-events: none; }
  ...
  footer.footer .footer-col h6::after { content: ''; position: absolute; bottom: -14px; left: 0; width: 45px; height: 3px; background: linear-gradient(90deg, rgba(193,154,78,1), rgba(255,224,133,0.3)); border-radius: 99px; }
  ...
  footer.footer .social-icons a { width: 38px; height: 38px; display: inline-flex; align-items: center; justify-content: center; border: 1px solid rgba(193, 154, 78, 0.24); border-radius: 50%; color: #e2e8f0 !important; transition: all 0.3s ease; background: rgba(255,255,255,0.02); }
...
<style>
  ...
  :root.theme-default .newsletter-promo h2 {
      background: linear-gradient(135deg, #3d241c 20%, #CD9A48 100%);
  ...
  :root.theme-luxury .newsletter-promo h2 {
      background: linear-gradient(135deg, #ffffff 30%, #c19a4e 100%);
      -webkit-background-clip: text !important;
      -webkit-text-fill-color: transparent !important;
      text-shadow: 0 2px 15px rgba(193, 154, 78, 0.15);
  }
  ...
  :root.theme-luxury .newsletter-promo .newsletter-cta input {
      ...
      border: 1.5px solid rgba(193, 154, 78, 0.25) !important;
      color: #ffffff !important;
  }
  :root.theme-luxury .newsletter-promo .newsletter-cta input:focus {
      border-color: #c19a4e !important;
      box-shadow: 0 0 0 4px rgba(193, 154, 78, 0.15) !important;
  }
  :root.theme-luxury .newsletter-promo .newsletter-cta button {
      background: linear-gradient(135deg, #c19a4e, #a37f3b) !important;
      color: #1a0f0a !important;
      box-shadow: 0 10px 24px rgba(193, 154, 78, 0.25) !important;
  }
  :root.theme-luxury .newsletter-promo .newsletter-cta button:hover {
      background: linear-gradient(135deg, #d8ad5a, #bfa04a) !important;
      box-shadow: 0 12px 30px rgba(193, 154, 78, 0.4) !important;
  }
  ...
  .newsletter-promo::before {
      ...
      top: -85px;
      right: -50px;
      background: radial-gradient(circle, var(--accent-bronze, #CD9A48) 0%, transparent 80%);
  }
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-xl-9 text-center">
        ...
        <form class="newsletter-cta" method="POST" action="<?= BASE_URL; ?>/index.php?page=subscribe_newsletter">
          <input type="hidden" name="redirect" value="<?= htmlspecialchars($_SERVER['REQUEST_URI'] ?? BASE_URL . '/index.php?page=home'); ?>">
