                    ...
                    <?php else: ?>
                        <?php foreach ($claims as $c): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-light text-dark border px-2 py-1 mb-1 font-monospace"><i class="bi bi-qr-code me-1"></i><?= htmlspecialchars($c['code']) ?></span><br>
                                ...
                                <td>
                                    ...
                                    <?php if ($c['image_url']): ?>
                                        <a href="<?= BASE_URL . $c['image_url'] ?>" target="_blank" class="badge bg-info mt-1 text-decoration-none"><i class="bi bi-image me-1"></i>View Attachment</a>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php 
